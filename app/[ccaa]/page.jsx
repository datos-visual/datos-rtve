...
export default async function CcaaPage({ params }) {
  ...
  // Obtener nombre y URL de la comunidad autónoma
  const ccaaName = ccaaFosas[0]?.ccaa || params.ccaa;
  ...
  const webPageJsonLd = {
    ...
    "@type": "WebPage",
    url: ccaaUrl,
    name: `Fosas de ${ccaaName} | RTVE.es`,
    description: `Listado de fosas de la Guerra Civil y el franquismo en ${ccaaName}. Proyecto RTVE.es`,
