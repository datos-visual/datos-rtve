...
// api: https://api.rtve.es/datos-repo/test-fosas/guia-optimizado.json

export const JSON_URL = `https://www.rtve.es/datos-repo/test-fosas/guia-optimizado.json?${Date.now()}`;
